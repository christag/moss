-- ============================================================================
-- Migration 021: Seed Default Dropdown Options
-- ============================================================================
-- Purpose: Auto-populate dropdown_field_options with default values
-- Source: Extracted from seeds/005_dropdown_options.sql
-- Total: ~200 options across 29 fields in 16 object types
-- Idempotent: Uses ON CONFLICT DO NOTHING to safely run multiple times
-- ============================================================================
...
ON CONFLICT (object_type, field_name, option_value) DO NOTHING;
...
DECLARE
    v_count INTEGER;
BEGIN
    SELECT COUNT(*) INTO v_count FROM dropdown_field_options;

    RAISE NOTICE '==============================================';
    RAISE NOTICE 'Migration 021: Seed Dropdown Defaults';
    RAISE NOTICE '==============================================';
    RAISE NOTICE 'Seeded dropdown options for 29 fields across 16 object types';
    RAISE NOTICE 'Total options in database: %', v_count;
    RAISE NOTICE 'All options marked as system (is_system=true)';
    RAISE NOTICE 'Colors assigned for visual badges';
    RAISE NOTICE '';
    RAISE NOTICE 'Navigate to /admin/fields to manage dropdown options';
    RAISE NOTICE '==============================================';
END $$;
